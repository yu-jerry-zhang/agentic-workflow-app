...
class CreativeAgent(Agent):
    ...
    def write_prompt(self, analysis):
        ...
        prompt = f"""
        Act as an expert Prompt Engineer. Write a prompt for Stable Diffusion XL.
        
        Context:
        The product has this aesthetic: {style}
        It has these visual features: {', '.join(visuals)}
        
        The prompt should be comma-separated, focusing on:
        Subject description, Art Style, Lighting, Camera Angle, Texture details.
        """
